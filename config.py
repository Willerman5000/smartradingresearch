...
VERSION = "RFV1_6_1_COVERAGE_COMPLETE_20260913"
...
CAUSAL_VALIDATION_RESCUE_MAX_CELLS = _int("RESEARCH_CAUSAL_VALIDATION_RESCUE_MAX_CELLS", 18, 0, 18)
CAUSAL_REGISTRY_RETEST_LIMIT = _int("RESEARCH_CAUSAL_REGISTRY_RETEST_LIMIT", 8, 0, 30)

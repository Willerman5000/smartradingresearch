...
VERSION = "RFV1_15_RC9_7_CONTINGENCY_COLDSTART_60CELL_20260918"
SCHEDULER_POLICY_VERSION = "RC9_7_FAST20_CONTINGENCY_COLDSTART_FREEPLAN"
RELEASE_LABEL = "V1.1 · BACKTEST-PRIMARY EDGE · FAST PRIORITY"
...
EGRESS_DAILY_MB = min(_int("RESEARCH_EGRESS_DAILY_MB", 2, 1, 64), 2) if FREE_PLAN_MODE else _int("RESEARCH_EGRESS_DAILY_MB", 10, 1, 64)
